...
public class Shop extends BasicGameState {
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		Shop = new Image("/res/images/background/shopScreen.png").getScaledCopy(Main.getScreenWidth(),
	...
	public void keyPressed(int key, char c) {
		...
		if (index >= 0 && index < shopItems.size()) {
			if (Game.hasMoney(shopItems.get(index).getCost()) && Game.getItems().hasSpace()) {
